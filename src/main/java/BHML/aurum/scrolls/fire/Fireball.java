...
public class Fireball implements Scroll {
    ...
    public void cast(Player player) {
        ...
        Vector direction = origin.getDirection().normalize().multiply(1.4); // Launch velocity
        ...
        new BukkitRunnable() {
            ...
            private void triggerExplosion(Location loc) {
                ...
                world.spawnParticle(Particle.FLAME, loc, 80, 0.5, 0.5, 0.5, 0.01);
                world.spawnParticle(Particle.FLAME, loc, 120, 1.1, 1.1, 1.1, 0.1);
                world.spawnParticle(Particle.FLAME, loc, 20, 0.5, 0.5, 0.5, 0.5);
                world.spawnParticle(Particle.LAVA, loc, 25, 0.4, 0.4, 0.4, 0.02);
                world.spawnParticle(Particle.SMOKE, loc, 25, 0.5, 0.5, 0.5, 0.03);
                world.playSound(loc, Sound.ITEM_FIRECHARGE_USE, 0.8f, 1.5f);

                for (Entity aoe : world.getNearbyEntities(loc, 2.5, 2.5, 2.5)) {
