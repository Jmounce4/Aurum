...
import BHML.aurum.runes.normal.InstinctListener;
import BHML.aurum.runes.normal.ConquerorListener;
...
import BHML.aurum.runes.lightning.ConductiveListener;
...
public final class Aurum extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getServer().getPluginManager().registerEvents(new ConquerorListener(), this);
        ...
        getServer().getPluginManager().registerEvents(new ConductiveListener(), this);
